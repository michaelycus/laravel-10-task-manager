...
<template>
  <div>
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
      ...
      <NavLink :href="route('tasks.board')" :active="route().current('tasks.board')"> Task Board </NavLink>

      <h1 class="mt-8 text-2xl font-medium text-gray-900">Welcome to your Jetstream application!xccdd</h1>
